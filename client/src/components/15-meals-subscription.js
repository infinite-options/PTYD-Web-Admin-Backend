...
class FifteenMealSubscription extends Component {
  render() {
    return (
              ...
              >
                ...
                <span class="border border-dark" style={{}}>
                  ...
                  <Card.Body>
                    ...
                    <br></br>
                    <Card.Title>$164⁹⁹ /week</Card.Title>
              ...
              >
                <span class="border border-dark" style={{}}>
                  ...
                  <Card.Body>
                    ...
                    <br></br>
                    <Card.Title>$148⁵⁰ /week</Card.Title>
                    <Card.Text style={{ fontSize: "13px", color: "#888785" }}>
                      Sales tax of 8.25% will be added
                    </Card.Text>
                    <Link
              ...
              >
                <span class="border border-dark" style={{}}>
                  ...
                  <Card.Body>
                    ...
                    <br></br>
                    <Card.Title>$139⁵ /week</Card.Title>
                    <Card.Text style={{ fontSize: "13px", color: "#888785" }}>
                      Sales tax of 8.25% will be added
                    </Card.Text>
                    <Link
...
export default FifteenMealSubscription;
