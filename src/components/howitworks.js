      ...
      <div class="container" style={{ color: "white" }}>
        ...
        <Grid>
          ...
          <Cell col={7} style={{ color: "black", lineHeight: "55px" }}>
            ...
            <Row style={{ color: "black", lineHeight: "55px" }}>
              ...
              <Col>
                <p style={{ color: "#888785", lineHeight: "20px" }}>
                  ...
                  our plans are subscriptions. If you place an order this week,
                  your first delivery will arrive next week. Your subscription
                  can be changed, paused or cancelled at any time - you are
                  never locked in.
                </p>
              </Col>
            </Row>
            ...
            <Row style={{ color: "black", lineHeight: "55px" }}>
              <Col>
                <p style={{ color: "#888785", lineHeight: "20px" }}>
                  Yes. You are able to choose your meals with our customization
                  feature. Once you've selected your base plan (for example: 10
                  meals weekly), you can to select your favorite meals of the
                  week.
                </p>
              </Col>
              <Col>
        ...
        <Grid>
          ...
          >
            <Cell col={11}>
              ...
              <h5 style={{ color: "black", lineHeight: "5px" }}>What time?</h5>
              <h6>
              ...
              <h6>
                ...
                several hours. We will send you text updates before, during, and
                upon delivery.
              </h6>
              <h5 style={{ color: "black", lineHeight: "5px" }}>
              ...
              <h6>
                ...
                you who show interest the quicker we can service y'all. Send us
                a message!
              </h6>
            </Cell>
          </Cell>
        ...
        <div class="container">
          ...
          <CardColumns>
            <Card className="p-3">
              <p>
                Healthy, delicious, and delivered to your door at an affordable
                price. Hard to beat. As a bonus, the jars are eco-friendly. I
                can't wait to see PTYD expand.
              </p>
              <br />
              <br />
              <br />
            ...
            <Card className="p-3">
              <p>
                ...
                have any questions. I don't think I've ever had a meal I didn't
                like!
              </p>
              <br />
              <br />
